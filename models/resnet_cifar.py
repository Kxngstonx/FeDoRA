...
class ResNetCifar10(nn.Module):
    ...
    def __init__(self, block, layers, in_channels=3, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, use_projection_head=True, proj_out_dim=256):
        ...
        if self.use_projection_head:
            ...
            self.l2 = nn.Linear(num_ftrs, proj_out_dim)
...
def ResNet152_cifar10(**kwargs):
    return ResNetCifar10(Bottleneck, [3, 8, 36, 3], **kwargs)
